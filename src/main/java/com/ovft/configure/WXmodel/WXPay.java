...
import com.ovft.configure.constant.WXPayConstants;
...
//        reqData.put("body", "商品详情信息");
//        reqData.put("mch_id", config.getMchID());
//        reqData.put("nonce_str", WXPayUtil.generateNonceStr());
//        reqData.put("notify_url", this.notifyUrl);
//        reqData.put("out_trade_no", "20190901090007169155");
//        reqData.put("spbill_create_ip", config.getIp());
//        reqData.put("timeStamp", String.valueOf(Calendar.getInstance().getTimeInMillis()));
...
//        TreeMap tmap = new TreeMap(reqData);
//        reqData = new HashMap<>(tmap);
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData,
        ...
        System.out.println("微信支付统一下单请求报文：" + reqBody);
        String resp = this.wxPayRequest.requestWithoutCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs, readTimeoutMs, autoReport);
        System.out.println("微信支付统一下单返回报文”" + resp);
        return resp;
    }
