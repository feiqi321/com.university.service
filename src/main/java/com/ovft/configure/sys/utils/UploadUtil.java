...
//    }
//
//    public static String[] uploadImges(Base64File[] base64File) {
//        List<String> path = new ArrayList<>();
//        for (Base64File file : base64File) {
//            MultipartFile multipartFile = BASE64DecodedMultipartFile.base64Convert(file.getContent());
//            String originalFilename = multipartFile.getOriginalFilename();
//            System.out.println(originalFilename);
//            String extName = originalFilename.substring(originalFilename.lastIndexOf(".") + 1);
//            System.out.println(extName);
...
//            }
//        }
//        String[] paths = path.toArray(new String[path.size()]);
//        return paths;
//    }
//
//
